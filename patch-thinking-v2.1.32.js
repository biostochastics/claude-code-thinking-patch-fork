...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.32 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function Cj6(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(Cj6SearchPattern)) {
    content = content.replace(Cj6SearchPattern, Cj6StandardReplacement);
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.32 (Standard)');
  console.log('========================================================');
