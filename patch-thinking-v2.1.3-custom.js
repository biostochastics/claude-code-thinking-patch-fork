...
console.log('Claude Code Thinking Custom Style Patcher v2.1.3');
console.log('==================================================\n');
...
if (!fs.existsSync(claudePath)) {
  ...
  console.error('Please make sure Claude Code v2.1.3 is installed.');
  process.exit(1);
}
...
if (content.includes(dvASearchPattern)) {
  ...
  console.log('   1. Wrong Claude Code version (this is for v2.1.3)');
...
if (patchApplied) {
  ...
  console.error('This script is for Claude Code v2.1.3');
  process.exit(1);
}
