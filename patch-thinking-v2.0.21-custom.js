...
console.log('Claude Code Thinking Custom Style Patcher v2.0.21');
console.log('==================================================\n');
...
if (!fs.existsSync(claudePath)) {
  ...
  console.error('Please make sure Claude Code v2.0.21 is installed.');
  process.exit(1);
}
...
// Patch 3: Custom H8Q styling with border and color (v2.0.21)
// Original H8Q function that we want to replace
const h8qSearchPattern = 'function H8Q({param:{thinking:A},addMargin:B=!1,isTranscriptMode:Q}){let[Z]=mB();if(!A)return null;if(!Q)return va.default.createElement(j,{marginTop:B?1:0},va.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return va.default.createElement(j,{flexDirection:"column",gap:1,marginTop:B?1:0,width:"100%"},va.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),va.default.createElement(j,{paddingLeft:2},va.default.createElement($,{dimColor:!0,italic:!0},WV(A,Z))))}';

// Old green version (for migration from previous versions)
const h8qOldGreenPattern = 'function H8Q({param:{thinking:A},addMargin:B=!1,isTranscriptMode:Q}){let[Z]=mB();if(!A)return null;if(!Q)return va.default.createElement(j,{marginTop:B?1:0},va.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return va.default.createElement(j,{flexDirection:"column",borderStyle:"single",borderColor:"suggestion",paddingX:1,marginTop:B?1:0,width:"100%"},va.default.createElement($,{color:"suggestion",bold:!0},"💭 Thinking Process"),va.default.createElement(j,{paddingLeft:1,marginTop:1},va.default.createElement($,{dimColor:!0},WV(A,Z))))}';

// Custom H8Q with border and orange color (peach emoji)
const h8qReplacement = 'function H8Q({param:{thinking:A},addMargin:B=!1,isTranscriptMode:Q}){let[Z]=mB();if(!A)return null;if(!Q)return va.default.createElement(j,{marginTop:B?1:0},va.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return va.default.createElement(j,{flexDirection:"column",borderStyle:"single",borderColor:"warning",paddingX:1,marginTop:B?1:0,width:"100%"},va.default.createElement($,{color:"warning",bold:!0},"🍑 Thinking Process"),va.default.createElement(j,{paddingLeft:1,marginTop:1},va.default.createElement($,{dimColor:!0},WV(A,Z))))}';
...
// Apply Patch 1
console.log('Applying Patch 1: wVB banner removal...');
...
// Apply Patch 3
console.log('\nApplying Patch 3: custom H8Q styling...');
if (content.includes(h8qSearchPattern)) {
  content = content.replace(h8qSearchPattern, h8qReplacement);
  patch3Applied = true;
  console.log('✅ Patch 3 applied: H8Q now has custom border and colors');
...
} else if (content.includes(h8qOldGreenPattern)) {
  content = content.replace(h8qOldGreenPattern, h8qReplacement);
  patch3Applied = true;
...
} else if (content.includes(h8qReplacement)) {
  console.log('ℹ️  Patch 3 already applied (orange peach version)');
  patch3Applied = true;
} else {
  console.log('⚠️  Patch 3 pattern not found');
  console.log('   This likely means:');
  console.log('   1. Wrong Claude Code version (this is for v2.0.21)');
  console.log('   2. H8Q function was modified by another patch');
...
if (patch1Applied || patch2Applied || patch3Applied) {
  ...
  console.error('This script is for Claude Code v2.0.21');
  process.exit(1);
}
