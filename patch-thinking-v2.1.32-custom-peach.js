...
// ============================================================
// Claude Code Thinking Custom Peach Style Patcher v2.1.32
...
// Patch patterns for v2.1.32
// Identifiers: Cj6 (component), L31 (React), I (Box), f (Text), $J (ThinkingContent), kK (keybind)
// Gate function: EPY (gates whether thinking blocks render at all)
const Cj6SearchPattern = 'function Cj6(A){let q=A1(17),{param:K,addMargin:Y,isTranscriptMode:z,hideInTranscript:w}=A,{thinking:H}=K,O=Y===void 0?!1:Y,$=w===void 0?!1:w,_=kK("app:toggleTranscript","Global","ctrl+o"),J;if(q[0]===Symbol.for("react.memo_cache_sentinel"))J=!1,q[0]=J;else J=q[0];if(!H&&!J)return null;if($)return null;let D=z,j;if(q[1]!==H)j="∴ Thinking",q[1]=H,q[2]=j;else j=q[2];let M=j;if(!D){let Z=O?1:0,N;if(q[3]!==_||q[4]!==M)N=L31.default.createElement(f,{dimColor:!0,italic:!0},M," (",_," to expand)"),q[3]=_,q[4]=M,q[5]=N;else N=q[5];let T;if(q[6]!==Z||q[7]!==N)T=L31.default.createElement(I,{marginTop:Z},N),q[6]=Z,q[7]=N,q[8]=T;else T=q[8];return T}let W=O?1:0,G;if(q[9]!==M)G=L31.default.createElement(f,{dimColor:!0,italic:!0},M,"…"),q[9]=M,q[10]=G;else G=q[10];let P;if(q[11]!==H)P=L31.default.createElement(I,{paddingLeft:2},L31.default.createElement($J,{dimColor:!0},H)),q[11]=H,q[12]=P;else P=q[12];let V;if(q[13]!==W||q[14]!==G||q[15]!==P)V=L31.default.createElement(I,{flexDirection:"column",gap:1,marginTop:W,width:"100%"},G,P),q[13]=W,q[14]=G,q[15]=P,q[16]=V;else V=q[16];return V}';

// EPY function patterns - this function gates whether thinking blocks are rendered at all
// The check `if(!j&&!Z)return null` blocks rendering when not in transcript mode
// We need to change both occurrences (for redacted_thinking and thinking cases) to if(!1)
const EPYSearchPattern = 'case"redacted_thinking":{if(!j&&!Z)return null;';
const EPYReplacement = 'case"redacted_thinking":{if(!1)return null;';
const EPYThinkingSearchPattern = 'case"thinking":{if(!j&&!Z)return null;';
const EPYThinkingReplacement = 'case"thinking":{if(!1)return null;';
...
const Cj6CustomReplacement = 'function Cj6(A){let q=A1(17),{param:K,addMargin:Y,isTranscriptMode:z,hideInTranscript:w}=A,{thinking:H}=K,O=Y===void 0?!1:Y,$=w===void 0?!1:w,_=kK("app:toggleTranscript","Global","ctrl+o"),J;if(q[0]===Symbol.for("react.memo_cache_sentinel"))J=!1,q[0]=J;else J=q[0];if(!H&&!J)return null;if(!1)return null;let D=z,j;if(q[1]!==H)j="∴ Thinking",q[1]=H,q[2]=j;else j=q[2];let M=j;if(!1){let Z=O?1:0,N;if(q[3]!==_||q[4]!==M)N=L31.default.createElement(f,{dimColor:!0,italic:!0},M," (",_," to expand)"),q[3]=_,q[4]=M,q[5]=N;else N=q[5];let T;if(q[6]!==Z||q[7]!==N)T=L31.default.createElement(I,{marginTop:Z},N),q[6]=Z,q[7]=N,q[8]=T;else T=q[8];return T}let W=O?1:0,G;if(q[9]!==M)G=L31.default.createElement(f,{color:"warning",bold:!0},"\u{1F351} Thinking Process"),q[9]=M,q[10]=G;else G=q[10];let P;if(q[11]!==H)P=L31.default.createElement(I,{paddingLeft:1,marginTop:1},L31.default.createElement($J,null,H)),q[11]=H,q[12]=P;else P=q[12];let V;if(q[13]!==W||q[14]!==G||q[15]!==P)V=L31.default.createElement(I,{flexDirection:"column",borderStyle:"single",borderColor:"warning",paddingX:1,marginTop:W,overflow:"hidden"},G,P),q[13]=W,q[14]=G,q[15]=P,q[16]=V;else V=q[16];return V}';

// Standard replacement (for detection and upgrade)
const Cj6StandardReplacement = 'function Cj6(A){let q=A1(17),{param:K,addMargin:Y,isTranscriptMode:z,hideInTranscript:w}=A,{thinking:H}=K,O=Y===void 0?!1:Y,$=w===void 0?!1:w,_=kK("app:toggleTranscript","Global","ctrl+o"),J;if(q[0]===Symbol.for("react.memo_cache_sentinel"))J=!1,q[0]=J;else J=q[0];if(!H&&!J)return null;if(!1)return null;let D=z,j;if(q[1]!==H)j="∴ Thinking",q[1]=H,q[2]=j;else j=q[2];let M=j;if(!1){let Z=O?1:0,N;if(q[3]!==_||q[4]!==M)N=L31.default.createElement(f,{dimColor:!0,italic:!0},M," (",_," to expand)"),q[3]=_,q[4]=M,q[5]=N;else N=q[5];let T;if(q[6]!==Z||q[7]!==N)T=L31.default.createElement(I,{marginTop:Z},N),q[6]=Z,q[7]=N,q[8]=T;else T=q[8];return T}let W=O?1:0,G;if(q[9]!==M)G=L31.default.createElement(f,{dimColor:!0,italic:!0},M,"…"),q[9]=M,q[10]=G;else G=q[10];let P;if(q[11]!==H)P=L31.default.createElement(I,{paddingLeft:2},L31.default.createElement($J,{dimColor:!0},H)),q[11]=H,q[12]=P;else P=q[12];let V;if(q[13]!==W||q[14]!==G||q[15]!==P)V=L31.default.createElement(I,{flexDirection:"column",gap:1,marginTop:W,width:"100%"},G,P),q[13]=W,q[14]=G,q[15]=P,q[16]=V;else V=q[16];return V}';

// Old custom replacement pattern (with hex colors - has rendering issues)
const Cj6OldCustomReplacement = 'borderColor:"#FFA500",paddingX:1,marginTop:W,width:"100%"';

function checkPatchStatus(filePath) {
  try {
    const content = fs.readFileSync(filePath, 'utf8');

    // Check EPY patch status (the outer gate that controls if thinking blocks render at all)
    const epyPatched = content.includes(EPYReplacement) && content.includes(EPYThinkingReplacement);
    const epyNeedsPatching = content.includes(EPYSearchPattern) || content.includes(EPYThinkingSearchPattern);

    // Check for new custom peach patched version (this script's target with theme colors)
    if (content.includes(Cj6CustomReplacement)) {
      if (epyPatched) {
        return { status: 'patched', canPatch: false, variant: 'custom-peach-v3' };
      } else if (epyNeedsPatching) {
        return { status: 'patched-other', canPatch: true, variant: 'custom-peach-v2-no-epy', note: 'Has Cj6 patch but missing EPY gate patch (thinking hidden by default)' };
      }
    ...
    if (content.includes(Cj6OldCustomReplacement) && content.includes('\u{1F351} Thinking Process')) {
    ...
    if (content.includes(Cj6StandardReplacement)) {
      return { status: 'patched-other', canPatch: true, variant: 'standard', note: 'Has standard patch, can upgrade to custom' };
    }

    // Check for any other patch variant (has the if(!1) pattern in Cj6 but different styling)
    if (content.includes('function Cj6(A)') && content.match(/function Cj6\(A\)[^}]*if\(!1\)return null/)) {
      if (epyNeedsPatching) {
        return { status: 'patched-other', canPatch: true, variant: 'partial-no-epy', note: 'Cj6 patched but EPY gate not patched (thinking hidden by default)' };
      }
      return { status: 'patched', canPatch: false, variant: 'custom-other' };
    }

    // Check for unpatched original
    if (content.includes(Cj6SearchPattern)) {
      return { status: 'unpatched', canPatch: true };
    }

    // Check if it's a different version (has Cj6 but different pattern)
    ...
    return { status: 'unknown', canPatch: false, reason: 'Cj6 function not found (wrong version?)' };
  } catch (e) {
    return { status: 'error', canPatch: false, reason: e.message };
  }
}

// Old Cj6 custom replacement (with hex colors - for upgrading)
const Cj6OldCustomReplacementFull = 'function Cj6(A){let q=A1(17),{param:K,addMargin:Y,isTranscriptMode:z,hideInTranscript:w}=A,{thinking:H}=K,O=Y===void 0?!1:Y,$=w===void 0?!1:w,_=kK("app:toggleTranscript","Global","ctrl+o"),J;if(q[0]===Symbol.for("react.memo_cache_sentinel"))J=!1,q[0]=J;else J=q[0];if(!H&&!J)return null;if(!1)return null;let D=z,j;if(q[1]!==H)j="∴ Thinking",q[1]=H,q[2]=j;else j=q[2];let M=j;if(!1){let Z=O?1:0,N;if(q[3]!==_||q[4]!==M)N=L31.default.createElement(f,{dimColor:!0,italic:!0},M," (",_," to expand)"),q[3]=_,q[4]=M,q[5]=N;else N=q[5];let T;if(q[6]!==Z||q[7]!==N)T=L31.default.createElement(I,{marginTop:Z},N),q[6]=Z,q[7]=N,q[8]=T;else T=q[8];return T}let W=O?1:0,G;if(q[9]!==M)G=L31.default.createElement(f,{color:"#FFA500",bold:!0},"\u{1F351} Thinking Process"),q[9]=M,q[10]=G;else G=q[10];let P;if(q[11]!==H)P=L31.default.createElement(I,{paddingLeft:1,marginTop:1},L31.default.createElement($J,null,H)),q[11]=H,q[12]=P;else P=q[12];let V;if(q[13]!==W||q[14]!==G||q[15]!==P)V=L31.default.createElement(I,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:W,width:"100%"},G,P),q[13]=W,q[14]=G,q[15]=P,q[16]=V;else V=q[16];return V}';
...
function applyPatch(installation) {
  ...
  let modified = false;
  let epyPatched = false;

  // First, always check and apply EPY patches (the outer gate)
  if (content.includes(EPYSearchPattern)) {
    content = content.replace(EPYSearchPattern, EPYReplacement);
    epyPatched = true;
    console.log('   ✅ EPY redacted_thinking gate patched: if(!j&&!Z) -> if(!1)');
  }
  if (content.includes(EPYThinkingSearchPattern)) {
    content = content.replace(EPYThinkingSearchPattern, EPYThinkingReplacement);
    epyPatched = true;
    console.log('   ✅ EPY thinking gate patched: if(!j&&!Z) -> if(!1)');
  }

  // Check if Cj6 is already fully patched with custom peach style
  if (content.includes(Cj6CustomReplacement)) {
    if (epyPatched) {
      fs.writeFileSync(installation.path, content, 'utf8');
      console.log('   ✅ EPY gate patches applied (Cj6 was already patched)');
      return true;
    }
  ...
  if (content.includes(Cj6OldCustomReplacementFull)) {
    content = content.replace(Cj6OldCustomReplacementFull, Cj6CustomReplacement);
    modified = true;
    console.log('   ✅ Cj6 upgraded from hex colors to theme colors!');
  }
  // Can patch from standard version too
  else if (content.includes(Cj6StandardReplacement)) {
    content = content.replace(Cj6StandardReplacement, Cj6CustomReplacement);
    modified = true;
    console.log('   ✅ Cj6 upgraded from standard to custom peach style!');
  }
  // Patch fresh from original
  else if (content.includes(Cj6SearchPattern)) {
    content = content.replace(Cj6SearchPattern, Cj6CustomReplacement);
    modified = true;
    console.log('   ✅ Cj6 patch applied!');
    ...
    console.log('      - Changed header to "\u{1F351} Thinking Process" with bold text');
  }

  if (modified || epyPatched) {
    fs.writeFileSync(installation.path, content, 'utf8');
    if (!modified && epyPatched) {
      console.log('   ✅ EPY gate patches applied successfully!');
    }
    return true;
  } else {
...
async function main() {
  console.log('Claude Code Thinking Custom Peach Style Patcher v2.1.32');
  console.log('========================================================');
  ...
  if (installations.length === 0) {
    ...
    console.error('Please make sure Claude Code v2.1.32 is installed via npm.');
  ...
  for (let i = 0; i < installations.length; i++) {
    ...
    if (status.status === 'patched') {
      const variantLabel = status.variant === 'custom-peach' ? 'custom \u{1F351}' :
  ...
  if (patchable.length === 0) {
    console.log('ℹ️  No installations need patching (all have custom \u{1F351} patch or incompatible)');
    process.exit(0);
  }
  ...
  console.log('   - Header text is "\u{1F351} Thinking Process" in bold orange');
