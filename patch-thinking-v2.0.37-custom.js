...
/**
 * Claude Code Thinking Custom Style Patcher - v2.0.37
 *
 ...
 * - React import: Fs.default.createElement (changed from hs.default in v2.0.36)
 * - Hook: EQ() for columns (changed from HQ() in v2.0.36)
 *
 * Usage:
 *   node patch-thinking-v2.0.37-custom.js
 *
 * To revert:
...
console.log('Claude Code Thinking Custom Style Patcher v2.0.37');
console.log('====================================================\n');
...
// Patch 1: n$Q Component Styling (v2.0.37)
// Original n$Q function (unpatched)
...
// Standard-patched n$Q function (with if(false))
const n$QStandardPatchedPattern = 'function n$Q({param:{thinking:A},addMargin:B=!1,isTranscriptMode:Q,verbose:I}){let[G]=EQ();if(!A)return null;if(false)return Fs.default.createElement(S,{marginTop:B?1:0},Fs.default.createElement(w,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return Fs.default.createElement(S,{flexDirection:"column",gap:1,marginTop:B?1:0,width:"100%"},Fs.default.createElement(w,{dimColor:!0,italic:!0},"∴ Thinking…"),Fs.default.createElement(S,{paddingLeft:2},Fs.default.createElement(w,{dimColor:!0,italic:!0},bC(A,G))))}';

// Custom n$Q with peach emoji and orange border (works with both original and patched)
const n$QReplacement = 'function n$Q({param:{thinking:A},addMargin:B=!1,isTranscriptMode:Q,verbose:I}){let[G]=EQ();if(!A)return null;if(false)return Fs.default.createElement(S,{marginTop:B?1:0},Fs.default.createElement(w,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return Fs.default.createElement(S,{flexDirection:"column",borderStyle:"single",borderColor:"warning",paddingX:1,marginTop:B?1:0,width:"100%"},Fs.default.createElement(w,{color:"warning",bold:!0},"🍑 Thinking Process"),Fs.default.createElement(S,{paddingLeft:1,marginTop:1},Fs.default.createElement(w,{dimColor:!0},bC(A,G))))}';

let patchApplied = false;
let patchSource = 'unknown';

// Apply Patch
console.log('Applying custom n$Q styling...');
if (content.includes(n$QReplacement)) {
  console.log('ℹ️  Patch already applied (orange peach version)');
  patchApplied = true;
  patchSource = 'already-applied';
} else if (content.includes(n$QStandardPatchedPattern)) {
  content = content.replace(n$QStandardPatchedPattern, n$QReplacement);
  patchApplied = true;
  patchSource = 'standard-patched';
  console.log('✅ Patch applied: n$Q now has custom border and colors');
  ...
  content = content.replace(n$QOriginalPattern, n$QReplacement);
  patchApplied = true;
...
if (patchApplied) {
  ...
  console.log('Summary:');
  console.log(`- Custom n$Q style: APPLIED (source: ${patchSource})`);
