...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.109 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function oF8(q)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(oF8SearchPattern)) {
    content = content.replace(oF8SearchPattern, oF8StandardReplacement);
    modified = true;
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.109 (Standard)');
  console.log('========================================================');
