...
node patch-thinking-v2.1.104-custom-peach.js  # For npm-installed v2.1.104
...
```bash
claude --version
node patch-thinking-v2.1.104-custom-peach.js
```
...
```
patch-thinking-v2.1.104.js              # Latest standard (npm)
patch-thinking-v2.1.104-custom.js       # Latest custom (npm)
patch-thinking-v2.1.104-custom-peach.js # Latest custom peach (npm, recommended)
...
**Last updated:** 2026-04-12 · **Latest:** v2.1.104 (npm)
