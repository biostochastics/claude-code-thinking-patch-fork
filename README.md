...
```
patch-thinking-v2.1.85.js              # Latest standard (npm)
patch-thinking-v2.1.85-custom.js       # Latest custom (npm)
patch-thinking-v2.1.85-custom-peach.js # Latest custom peach (npm, recommended)
