...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.113 (Custom)
//
// FORMAT CHANGE: v2.1.113 ships a native Bun SEA binary
// (bin/claude.exe) instead of a cli.js. Only SAME-LENGTH byte
// replacements are possible; the historical "orange border /
// bold header" visual customizations from the cli.js era cannot
// be applied to the binary without relinking. This variant is
// kept for triplet parity and currently applies the same set
// of same-length patches as the Standard variant.
//
// Identifiers: Yl_ (component), g1H (React), m (Box), L (Text),
//   SA (ThinkingContent), R_7 (cache, 9 slots), iz (Spinner)
// Gate function: ni1 (not patched in this variant)
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.113 (Custom)');
  console.log('======================================================');
