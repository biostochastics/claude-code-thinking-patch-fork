...
console.log('Claude Code Thinking Patch v2.0.60');
console.log('====================================\n');
...
if (!fs.existsSync(claudePath)) {
  ...
  console.error('Please make sure Claude Code v2.0.60 is installed.');
  process.exit(1);
}
...
if (content.includes(thinkingSearchPattern)) {
  ...
  console.log('   1. Wrong Claude Code version (this is for v2.0.60)');
...
if (patchApplied) {
  ...
  console.error('This script is for Claude Code v2.0.60');
  process.exit(1);
}
