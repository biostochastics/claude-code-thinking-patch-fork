...
console.log('Claude Code Thinking Patch v2.0.49');
console.log('====================================\n');
...
// Patch: Thinking Visibility (v2.0.49)
// Component name: b92
// React import: zAA
// Hook: LB
const thinkingSearchPattern = 'function b92({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){let[Z]=LB();if(!A)return null;if(!(B||G))return zAA.default.createElement(j,{marginTop:Q?1:0},zAA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return zAA.default.createElement(j,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},zAA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),zAA.default.createElement(j,{paddingLeft:2},zAA.default.createElement($,{dimColor:!0,italic:!0},QD(A,Z))))}';

const thinkingReplacement = 'function b92({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){let[Z]=LB();if(!A)return null;if(!1)return zAA.default.createElement(j,{marginTop:Q?1:0},zAA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return zAA.default.createElement(j,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},zAA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),zAA.default.createElement(j,{paddingLeft:2},zAA.default.createElement($,{dimColor:!0,italic:!0},QD(A,Z))))}';
