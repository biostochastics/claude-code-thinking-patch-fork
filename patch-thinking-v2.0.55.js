...
console.log('Claude Code Thinking Patch v2.0.55');
console.log('====================================\n');
...
// Patch: Thinking Visibility (v2.0.55)
// Component name: J29
// React import: XQA
// Hook: OB
// Text helper: SD
const thinkingSearchPattern = 'function J29({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){let[Z]=OB();if(!A)return null;if(!(B||G))return XQA.default.createElement(j,{marginTop:Q?1:0},XQA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return XQA.default.createElement(j,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},XQA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),XQA.default.createElement(j,{paddingLeft:2},XQA.default.createElement($,{dimColor:!0,italic:!0},SD(A,Z))))}';

const thinkingReplacement = 'function J29({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){let[Z]=OB();if(!A)return null;if(!1)return XQA.default.createElement(j,{marginTop:Q?1:0},XQA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return XQA.default.createElement(j,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},XQA.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),XQA.default.createElement(j,{paddingLeft:2},XQA.default.createElement($,{dimColor:!0,italic:!0},SD(A,Z))))}';
