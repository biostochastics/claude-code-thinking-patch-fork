...
// ============================================================
// Claude Code Thinking Custom Style Patcher v2.1.32
...
const Cj6CustomReplacement = 'function Cj6(A){let q=A1(17),{param:K,addMargin:Y,isTranscriptMode:z,hideInTranscript:w}=A,{thinking:H}=K,O=Y===void 0?!1:Y,$=w===void 0?!1:w,_=kK("app:toggleTranscript","Global","ctrl+o"),J;if(q[0]===Symbol.for("react.memo_cache_sentinel"))J=!1,q[0]=J;else J=q[0];if(!H&&!J)return null;if(!1)return null;let D=z,j;if(q[1]!==H)j="∴ Thinking",q[1]=H,q[2]=j;else j=q[2];let M=j;if(!1){let Z=O?1:0,N;if(q[3]!==_||q[4]!==M)N=L31.default.createElement(f,{dimColor:!0,italic:!0},M," (",_," to expand)"),q[3]=_,q[4]=M,q[5]=N;else N=q[5];let T;if(q[6]!==Z||q[7]!==N)T=L31.default.createElement(I,{marginTop:Z},N),q[6]=Z,q[7]=N,q[8]=T;else T=q[8];return T}let W=O?1:0,G;if(q[9]!==M)G=L31.default.createElement(f,{color:"#FFA500",bold:!0},"∴ Thinking"),q[9]=M,q[10]=G;else G=q[10];let P;if(q[11]!==H)P=L31.default.createElement(I,{paddingLeft:1,marginTop:1},L31.default.createElement($J,null,H)),q[11]=H,q[12]=P;else P=q[12];let V;if(q[13]!==W||q[14]!==G||q[15]!==P)V=L31.default.createElement(I,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:W,width:"100%"},G,P),q[13]=W,q[14]=G,q[15]=P,q[16]=V;else V=q[16];return V}';
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function Cj6(A)')) {
...
async function main() {
  console.log('Claude Code Thinking Custom Style Patcher v2.1.32');
  console.log('==================================================');
