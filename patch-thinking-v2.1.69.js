...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.69 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function LN1(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(LN1SearchPattern)) {
    content = content.replace(LN1SearchPattern, LN1StandardReplacement);
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.69 (Standard)');
  console.log('========================================================');
