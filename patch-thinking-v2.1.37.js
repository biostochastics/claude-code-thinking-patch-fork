...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.37 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function Mj6(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(Mj6SearchPattern)) {
    content = content.replace(Mj6SearchPattern, Mj6StandardReplacement);
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.37 (Standard)');
  console.log('========================================================');
