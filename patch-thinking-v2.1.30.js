...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.30 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function FD6(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(FD6SearchPattern)) {
    content = content.replace(FD6SearchPattern, FD6StandardReplacement);
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.30 (Standard)');
  console.log('========================================================');
