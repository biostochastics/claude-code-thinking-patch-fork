...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.90 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function AI8(q)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(AI8SearchPattern)) {
    content = content.replace(AI8SearchPattern, AI8StandardReplacement);
    modified = true;
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.90 (Standard)');
  console.log('========================================================');
