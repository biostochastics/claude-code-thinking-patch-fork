...
// ============================================================
// Claude Code Thinking Custom Style Patcher v2.1.63
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function qN1(A)')) {
...
async function main() {
  console.log('Claude Code Thinking Custom Style Patcher v2.1.63');
  console.log('==================================================');
