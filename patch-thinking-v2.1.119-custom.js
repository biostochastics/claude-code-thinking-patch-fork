...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.119 (Custom)
//
...
// Gate function: ZJ5 (not patched in this variant)
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.119 (Custom)');
  console.log('======================================================');
