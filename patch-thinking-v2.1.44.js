...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.44 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function dW6(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(dW6SearchPattern)) {
    content = content.replace(dW6SearchPattern, dW6StandardReplacement);
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.44 (Standard)');
  console.log('========================================================');
