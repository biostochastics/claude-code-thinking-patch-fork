...
console.log('Claude Code Thinking Custom Style Patcher v2.0.69');
console.log('==================================================\n');
...
// Patch: Custom sU2 styling with peach emoji and orange border (v2.0.69)
// Component name: sU2
// React import: ti
// Box component: j
// Text component: z
// Text wrapper: jM
const sU2SearchPattern = 'function sU2({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){if(!A)return null;if(!(B||G))return ti.default.createElement(j,{marginTop:Q?1:0},ti.default.createElement(z,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return ti.default.createElement(j,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},ti.default.createElement(z,{dimColor:!0,italic:!0},"∴ Thinking…"),ti.default.createElement(j,{paddingLeft:2},ti.default.createElement(z,{dimColor:!0,italic:!0},ti.default.createElement(jM,null,A))))}';

// Custom sU2 with peach emoji, orange border, and bold header
const sU2Replacement = 'function sU2({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G}){if(!A)return null;if(!1)return ti.default.createElement(j,{marginTop:Q?1:0},ti.default.createElement(z,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return ti.default.createElement(j,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:Q?1:0,width:"100%"},ti.default.createElement(z,{color:"#FFA500",bold:!0},"🍑 Thinking Process"),ti.default.createElement(j,{paddingLeft:1,marginTop:1},ti.default.createElement(z,{dimColor:!0},ti.default.createElement(jM,null,A))))}';

let patchApplied = false;

// Apply Patch
console.log('Applying patch: custom sU2 styling...');
if (content.includes(sU2SearchPattern)) {
  content = content.replace(sU2SearchPattern, sU2Replacement);
  patchApplied = true;
  console.log('✅ Patch applied: sU2 now has custom border and colors');
...
} else if (content.includes(sU2Replacement)) {
