...
console.log('Claude Code Thinking Custom Style Patcher v2.1.5');
console.log('==================================================\n');
...
if (!fs.existsSync(claudePath)) {
  ...
  console.error('Please make sure Claude Code v2.1.5 is installed.');
  process.exit(1);
}
...
// Patch: Custom dvA styling with peach emoji and orange border (v2.1.5)
// Component name: dvA (same as v2.1.4)
// React import: s4A
// Box component: T
// Text component: $
// Text wrapper: QV
...
if (content.includes(dvASearchPattern)) {
  ...
  console.log('   1. Wrong Claude Code version (this is for v2.1.5)');
...
if (patchApplied) {
  ...
  console.error('This script is for Claude Code v2.1.5');
  process.exit(1);
}
