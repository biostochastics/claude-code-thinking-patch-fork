...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.89 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function Wx8(q)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(Wx8SearchPattern)) {
    content = content.replace(Wx8SearchPattern, Wx8StandardReplacement);
    modified = true;
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.89 (Standard)');
  console.log('========================================================');
