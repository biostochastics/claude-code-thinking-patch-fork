...
/**
 * Claude Code Thinking Patch - v2.0.29
 *
 * This patch makes thinking blocks visible in Claude Code v2.0.29
 * by modifying the visibility control in the message renderer.
 *
 * Architecture Change in v2.0.29:
 ...
 * - Thinking component: LTQ (same as v2.0.28)
 * - isTranscriptMode variable: V (same as v2.0.28)
 * - React import: C3 (same as v2.0.28)
 *
 * Usage:
 *   node patch-thinking-v2.0.29.js
 */
...
console.log('Claude Code Thinking Patch - v2.0.29');
console.log('=====================================\n');
