...
// ============================================================
// Claude Code Thinking Custom Style Patcher v2.1.76
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function _N1(A)')) {
...
async function main() {
  console.log('Claude Code Thinking Custom Style Patcher v2.1.76');
  console.log('==================================================');
