...
// ============================================================
// Claude Code Thinking Custom Peach Style Patcher v2.1.89
...
// Patch patterns for v2.1.89
// Identifiers: Wx8 (component), DK6 (React), m (Box), T (Text), HA (ThinkingContent), $6 (cache)
// Gate function: EQz (gates whether thinking blocks render at all)
// Keybind helper: z2 sub-component
const Wx8SearchPattern = 'function Wx8(q){let K=$6(9),{param:_,addMargin:z,isTranscriptMode:Y,verbose:$,hideInTranscript:O}=q,{thinking:A}=_,w=z===void 0?!1:z,j=O===void 0?!1:O;if(!A)return null;if(j)return null;if(!(Y||$)){let W=w?1:0,D;if(K[0]===Symbol.for("react.memo_cache_sentinel"))D=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",DK6.default.createElement(z2,null)),K[0]=D;else D=K[0];let f;if(K[1]!==W)f=DK6.default.createElement(m,{marginTop:W},D),K[1]=W,K[2]=f;else f=K[2];return f}let J=w?1:0,M;if(K[3]===Symbol.for("react.memo_cache_sentinel"))M=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking","\u2026"),K[3]=M;else M=K[3];let X;if(K[4]!==A)X=DK6.default.createElement(m,{paddingLeft:2},DK6.default.createElement(HA,{dimColor:!0},A)),K[4]=A,K[5]=X;else X=K[5];let P;if(K[6]!==J||K[7]!==X)P=DK6.default.createElement(m,{flexDirection:"column",gap:1,marginTop:J,width:"100%"},M,X),K[6]=J,K[7]=X,K[8]=P;else P=K[8];return P}';

// EQz function patterns - this function gates whether thinking blocks are rendered at all
// The check `if(!X&&!O)return null` blocks rendering when not in transcript mode
// We need to change both occurrences (for redacted_thinking and thinking cases) to if(!1)
const EQzSearchPattern = 'case"redacted_thinking":{if(!X&&!O)return null;';
const EQzReplacement = 'case"redacted_thinking":{if(!1)return null;';
const EQzThinkingSearchPattern = 'case"thinking":{if(!X&&!O)return null;';
const EQzThinkingReplacement = 'case"thinking":{if(!1)return null;';
...
const redactThinkingSearchPattern = 'if(Y&&iCq(q)&&!g7()&&Z7().showThinkingSummaries!==!0)K.push(WM8);';
const redactThinkingReplacement = 'if(!1)K.push(WM8);';
...
const Wx8CustomReplacement = 'function Wx8(q){let K=$6(9),{param:_,addMargin:z,isTranscriptMode:Y,verbose:$,hideInTranscript:O}=q,{thinking:A}=_,w=z===void 0?!1:z,j=O===void 0?!1:O;if(!A)return null;if(!1)return null;if(!1){let W=w?1:0,D;if(K[0]===Symbol.for("react.memo_cache_sentinel"))D=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",DK6.default.createElement(z2,null)),K[0]=D;else D=K[0];let f;if(K[1]!==W)f=DK6.default.createElement(m,{marginTop:W},D),K[1]=W,K[2]=f;else f=K[2];return f}let J=w?1:0,M;if(K[3]===Symbol.for("react.memo_cache_sentinel"))M=DK6.default.createElement(T,{color:"warning",bold:!0},"\ud83c\udf51 Thinking Process"),K[3]=M;else M=K[3];let X;if(K[4]!==A)X=DK6.default.createElement(m,{paddingLeft:1,marginTop:1},DK6.default.createElement(HA,null,A)),K[4]=A,K[5]=X;else X=K[5];let P;if(K[6]!==J||K[7]!==X)P=DK6.default.createElement(m,{flexDirection:"column",borderStyle:"single",borderColor:"warning",paddingX:1,marginTop:J,overflow:"hidden"},M,X),K[6]=J,K[7]=X,K[8]=P;else P=K[8];return P}';

// Standard replacement (for detection and upgrade)
const Wx8StandardReplacement = 'function Wx8(q){let K=$6(9),{param:_,addMargin:z,isTranscriptMode:Y,verbose:$,hideInTranscript:O}=q,{thinking:A}=_,w=z===void 0?!1:z,j=O===void 0?!1:O;if(!A)return null;if(!1)return null;if(!1){let W=w?1:0,D;if(K[0]===Symbol.for("react.memo_cache_sentinel"))D=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",DK6.default.createElement(z2,null)),K[0]=D;else D=K[0];let f;if(K[1]!==W)f=DK6.default.createElement(m,{marginTop:W},D),K[1]=W,K[2]=f;else f=K[2];return f}let J=w?1:0,M;if(K[3]===Symbol.for("react.memo_cache_sentinel"))M=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking","\u2026"),K[3]=M;else M=K[3];let X;if(K[4]!==A)X=DK6.default.createElement(m,{paddingLeft:2},DK6.default.createElement(HA,{dimColor:!0},A)),K[4]=A,K[5]=X;else X=K[5];let P;if(K[6]!==J||K[7]!==X)P=DK6.default.createElement(m,{flexDirection:"column",gap:1,marginTop:J,width:"100%"},M,X),K[6]=J,K[7]=X,K[8]=P;else P=K[8];return P}';

// Old custom replacement pattern (with hex colors - has rendering issues)
const Wx8OldCustomReplacement = 'borderColor:"#FFA500",paddingX:1,marginTop:J,width:"100%"';
...
function checkPatchStatus(filePath) {
  try {
    ...
    // Check EQz patch status (the outer gate that controls if thinking blocks render at all)
    const EQzPatched = content.includes(EQzReplacement) && content.includes(EQzThinkingReplacement);
    const EQzNeedsPatching = content.includes(EQzSearchPattern) || content.includes(EQzThinkingSearchPattern);

    // Check for new custom peach patched version (this script's target with theme colors)
    if (content.includes(Wx8CustomReplacement)) {
      if (EQzPatched && redactPatched) {
        return { status: 'patched', canPatch: false, variant: 'custom-peach-v3' };
      } else if (EQzNeedsPatching || redactNeedsPatching) {
        const missing = [];
        if (EQzNeedsPatching) missing.push('EQz gate');
        if (redactNeedsPatching) missing.push('redact-thinking header');
        return { status: 'patched-other', canPatch: true, variant: 'custom-peach-incomplete', note: `Has Wx8 patch but missing: ${missing.join(', ')}` };
      }
    ...
    if (content.includes(Wx8OldCustomReplacement) && content.includes('\ud83c\udf51 Thinking Process')) {
    ...
    if (content.includes(Wx8StandardReplacement)) {
      return { status: 'patched-other', canPatch: true, variant: 'standard', note: 'Has standard patch, can upgrade to custom' };
    }

    // Check for any other patch variant (has the if(!1) pattern in Wx8 but different styling)
    if (content.includes('function Wx8(q)') && content.match(/function Wx8\(q\)[^}]*if\(!1\)return null/)) {
      if (EQzNeedsPatching) {
        return { status: 'patched-other', canPatch: true, variant: 'partial-no-EQz', note: 'Wx8 patched but EQz gate not patched (thinking hidden by default)' };
      }
      return { status: 'patched', canPatch: false, variant: 'custom-other' };
    }

    // Check for unpatched original
    if (content.includes(Wx8SearchPattern)) {
      return { status: 'unpatched', canPatch: true };
    }

    // Check if it's a different version (has Wx8 but different pattern)
    ...
    return { status: 'unknown', canPatch: false, reason: 'Wx8 function not found (wrong version?)' };
  } catch (e) {
    return { status: 'error', canPatch: false, reason: e.message };
  }
}

// Old Wx8 custom replacement (with hex colors - for upgrading)
const Wx8OldCustomReplacementFull = 'function Wx8(q){let K=$6(9),{param:_,addMargin:z,isTranscriptMode:Y,verbose:$,hideInTranscript:O}=q,{thinking:A}=_,w=z===void 0?!1:z,j=O===void 0?!1:O;if(!A)return null;if(!1)return null;if(!1){let W=w?1:0,D;if(K[0]===Symbol.for("react.memo_cache_sentinel"))D=DK6.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",DK6.default.createElement(z2,null)),K[0]=D;else D=K[0];let f;if(K[1]!==W)f=DK6.default.createElement(m,{marginTop:W},D),K[1]=W,K[2]=f;else f=K[2];return f}let J=w?1:0,M;if(K[3]===Symbol.for("react.memo_cache_sentinel"))M=DK6.default.createElement(T,{color:"#FFA500",bold:!0},"\ud83c\udf51 Thinking Process"),K[3]=M;else M=K[3];let X;if(K[4]!==A)X=DK6.default.createElement(m,{paddingLeft:1,marginTop:1},DK6.default.createElement(HA,null,A)),K[4]=A,K[5]=X;else X=K[5];let P;if(K[6]!==J||K[7]!==X)P=DK6.default.createElement(m,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:J,width:"100%"},M,X),K[6]=J,K[7]=X,K[8]=P;else P=K[8];return P}';
...
function applyPatch(installation) {
  ...
  // Next, always check and apply EQz patches (the outer gate)
  if (content.includes(EQzSearchPattern)) {
    content = content.replace(EQzSearchPattern, EQzReplacement);
    EQzPatchApplied = true;
    console.log('   \u2705 EQz redacted_thinking gate patched: if(!X&&!O) -> if(!1)');
  }
  if (content.includes(EQzThinkingSearchPattern)) {
    content = content.replace(EQzThinkingSearchPattern, EQzThinkingReplacement);
    EQzPatchApplied = true;
    console.log('   \u2705 EQz thinking gate patched: if(!X&&!O) -> if(!1)');
  }

  // Check if Wx8 is already fully patched with custom peach style
  if (content.includes(Wx8CustomReplacement)) {
    if (EQzPatchApplied || modified) {
      fs.writeFileSync(installation.path, content, 'utf8');
      console.log('   \u2705 Gate/redact patches applied (Wx8 was already patched)');
      return true;
    }
  ...
  if (content.includes(Wx8OldCustomReplacementFull)) {
    content = content.replace(Wx8OldCustomReplacementFull, Wx8CustomReplacement);
    modified = true;
    console.log('   \u2705 Wx8 upgraded from hex colors to theme colors!');
  }
  // Can patch from standard version too
  else if (content.includes(Wx8StandardReplacement)) {
    content = content.replace(Wx8StandardReplacement, Wx8CustomReplacement);
    modified = true;
    console.log('   \u2705 Wx8 upgraded from standard to custom peach style!');
  }
  // Patch fresh from original
  else if (content.includes(Wx8SearchPattern)) {
    content = content.replace(Wx8SearchPattern, Wx8CustomReplacement);
    modified = true;
    console.log('   \u2705 Wx8 patch applied!');
  ...
  if (modified || EQzPatchApplied) {
    fs.writeFileSync(installation.path, content, 'utf8');
    if (!modified && EQzPatchApplied) {
      console.log('   \u2705 EQz gate patches applied successfully!');
    }
    return true;
  } else {
...
async function main() {
  console.log('Claude Code Thinking Custom Peach Style Patcher v2.1.89');
  console.log('========================================================');
  ...
  if (installations.length === 0) {
    ...
    console.error('Please make sure Claude Code v2.1.89 is installed via npm.');
