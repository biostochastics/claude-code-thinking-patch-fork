...
// ============================================================
// Claude Code Thinking Custom Style Patcher v2.1.104
...
const Ng8CustomReplacement = 'function Ng8(q){let K=_6(9),{param:_,addMargin:z,isTranscriptMode:Y,verbose:A,hideInTranscript:O}=q,{thinking:w}=_,$=z===void 0?!1:z,j=O===void 0?!1:O;if(!w)return null;if(!1)return null;if(!1){let W=$?1:0,D;if(K[0]===Symbol.for("react.memo_cache_sentinel"))D=O96.default.createElement(V,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",O96.default.createElement(Uw,null)),K[0]=D;else D=K[0];let Z;if(K[1]!==W)Z=O96.default.createElement(u,{marginTop:W},D),K[1]=W,K[2]=Z;else Z=K[2];return Z}let J=$?1:0,X;if(K[3]===Symbol.for("react.memo_cache_sentinel"))X=O96.default.createElement(V,{color:"#FFA500",bold:!0},"\u2234 Thinking"),K[3]=X;else X=K[3];let M;if(K[4]!==w)M=O96.default.createElement(u,{paddingLeft:1,marginTop:1},O96.default.createElement(S2,null,w)),K[4]=w,K[5]=M;else M=K[5];let P;if(K[6]!==J||K[7]!==M)P=O96.default.createElement(u,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:J,width:"100%"},X,M),K[6]=J,K[7]=M,K[8]=P;else P=K[8];return P}';
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function Ng8(q)')) {
...
async function main() {
  console.log('Claude Code Thinking Custom Style Patcher v2.1.104');
  console.log('==================================================');
