...
console.log('Claude Code Thinking Patch v2.1.2');
console.log('====================================\n');
...
// Patch: Thinking Visibility (v2.1.2)
// Component name: ybA
// React import: q6A
// Box component: T
// Text component: $
...
const thinkingSearchPattern = 'function ybA({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G,hideInTranscript:Z=!1}){if(!A)return null;if(Z)return null;if(!(B||G))return q6A.default.createElement(T,{marginTop:Q?1:0},q6A.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return q6A.default.createElement(T,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},q6A.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),q6A.default.createElement(T,{paddingLeft:2},q6A.default.createElement(gK,null,A)))}';

const thinkingReplacement = 'function ybA({param:{thinking:A},addMargin:Q=!1,isTranscriptMode:B,verbose:G,hideInTranscript:Z=!1}){if(!A)return null;if(!1)return null;if(!1)return q6A.default.createElement(T,{marginTop:Q?1:0},q6A.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking (ctrl+o to expand)"));return q6A.default.createElement(T,{flexDirection:"column",gap:1,marginTop:Q?1:0,width:"100%"},q6A.default.createElement($,{dimColor:!0,italic:!0},"∴ Thinking…"),q6A.default.createElement(T,{paddingLeft:2},q6A.default.createElement(gK,null,A)))}';
