...
// ============================================================
// Claude Code Thinking Display Patcher v2.1.76 (Standard)
...
function checkPatchStatus(filePath) {
  try {
    ...
    if (content.includes('if(!1)return null;') && content.includes('function _N1(A)') && content.includes('borderStyle')) {
...
function applyPatch(installation) {
  ...
  if (content.includes(_N1SearchPattern)) {
    content = content.replace(_N1SearchPattern, _N1StandardReplacement);
    modified = true;
...
async function main() {
  console.log('Claude Code Thinking Display Patcher v2.1.76 (Standard)');
  console.log('========================================================');
