...
// ============================================================
// Claude Code Thinking Custom Peach Style Patcher v2.1.112
...
// Patch patterns for v2.1.112
// Identifiers: cg8 (component), R96 (React), u (Box), T (Text), xw (ThinkingContent), s (cache)
// Gate function: wKY (gates whether thinking blocks render at all)
// Keybind helper: I2 sub-component
const cg8SearchPattern = 'function cg8(q){let K=s(17),{param:_,addMargin:z,isTranscriptMode:Y,verbose:A,hideInTranscript:O}=q,{thinking:w}=_,$=z===void 0?!1:z,j=O===void 0?!1:O;if(!w)return null;if(j)return null;if(!(Y||A)){let W=$?1:0,D;if(K[8]===Symbol.for("react.memo_cache_sentinel"))D=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",R96.default.createElement(U2,null)),K[8]=D;else D=K[8];let Z;if(K[9]!==W)Z=R96.default.createElement(u,{marginTop:W},D),K[9]=W,K[10]=Z;else Z=K[10];return Z}let J=$?1:0,X;if(K[11]===Symbol.for("react.memo_cache_sentinel"))X=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking","\u2026"),K[11]=X;else X=K[11];let M;if(K[12]!==w)M=R96.default.createElement(u,{paddingLeft:2},R96.default.createElement(xw,{dimColor:!0},w)),K[12]=w,K[13]=M;else M=K[13];let P;if(K[14]!==J||K[15]!==M)P=R96.default.createElement(u,{flexDirection:"column",gap:1,marginTop:J,width:"100%"},X,M),K[14]=J,K[15]=M,K[16]=P;else P=K[16];return P}';

// wKY function patterns - this function gates whether thinking blocks are rendered at all
// The check `if(!M&&!O)return null` blocks rendering when not in transcript mode
// We need to change both occurrences (for redacted_thinking and thinking cases) to if(!1)
const wKYSearchPattern = 'case"redacted_thinking":{if(!M&&!O)return null;';
const wKYReplacement = 'case"redacted_thinking":{if(!1)return null;';
const wKYThinkingSearchPattern = 'case"thinking":{if(!M&&!O)return null;';
const wKYThinkingReplacement = 'case"thinking":{if(!1)return null;';
...
const redactThinkingSearchPattern = 'if(Y&&ggq(q)&&!I7()&&v7().showThinkingSummaries!==!0)K.push(pZ8);';
const redactThinkingReplacement = 'if(!1)K.push(pZ8);';

// Custom replacement with peach emoji, orange border, and bold header
// Changes: if(j) -> if(!1), if(!(Y||A)) -> if(!1), plus custom styling
// Uses "warning" theme color for borders (orange-ish) and overflow:hidden for proper rendering
const cg8CustomReplacement = 'function cg8(q){let K=s(17),{param:_,addMargin:z,isTranscriptMode:Y,verbose:A,hideInTranscript:O}=q,{thinking:w}=_,$=z===void 0?!1:z,j=O===void 0?!1:O;if(!w)return null;if(!1)return null;if(!1){let W=$?1:0,D;if(K[8]===Symbol.for("react.memo_cache_sentinel"))D=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",R96.default.createElement(U2,null)),K[8]=D;else D=K[8];let Z;if(K[9]!==W)Z=R96.default.createElement(u,{marginTop:W},D),K[9]=W,K[10]=Z;else Z=K[10];return Z}let J=$?1:0,X;if(K[11]===Symbol.for("react.memo_cache_sentinel"))X=R96.default.createElement(T,{color:"warning",bold:!0},"\ud83c\udf51 Thinking Process"),K[11]=X;else X=K[11];let M;if(K[12]!==w)M=R96.default.createElement(u,{paddingLeft:1,marginTop:1},R96.default.createElement(xw,null,w)),K[12]=w,K[13]=M;else M=K[13];let P;if(K[14]!==J||K[15]!==M)P=R96.default.createElement(u,{flexDirection:"column",borderStyle:"single",borderColor:"warning",paddingX:1,marginTop:J,overflow:"hidden"},X,M),K[14]=J,K[15]=M,K[16]=P;else P=K[16];return P}';

// Standard replacement (for detection and upgrade)
const cg8StandardReplacement = 'function cg8(q){let K=s(17),{param:_,addMargin:z,isTranscriptMode:Y,verbose:A,hideInTranscript:O}=q,{thinking:w}=_,$=z===void 0?!1:z,j=O===void 0?!1:O;if(!w)return null;if(!1)return null;if(!1){let W=$?1:0,D;if(K[8]===Symbol.for("react.memo_cache_sentinel"))D=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",R96.default.createElement(U2,null)),K[8]=D;else D=K[8];let Z;if(K[9]!==W)Z=R96.default.createElement(u,{marginTop:W},D),K[9]=W,K[10]=Z;else Z=K[10];return Z}let J=$?1:0,X;if(K[11]===Symbol.for("react.memo_cache_sentinel"))X=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking","\u2026"),K[11]=X;else X=K[11];let M;if(K[12]!==w)M=R96.default.createElement(u,{paddingLeft:2},R96.default.createElement(xw,{dimColor:!0},w)),K[12]=w,K[13]=M;else M=K[13];let P;if(K[14]!==J||K[15]!==M)P=R96.default.createElement(u,{flexDirection:"column",gap:1,marginTop:J,width:"100%"},X,M),K[14]=J,K[15]=M,K[16]=P;else P=K[16];return P}';

// Old custom replacement (with hex colors - has rendering issues)
const cg8OldCustomReplacement = 'borderColor:"#FFA500",paddingX:1,marginTop:J,width:"100%"';
...
function checkPatchStatus(filePath) {
  try {
    ...
    // Check wKY patch status (the outer gate that controls if thinking blocks render at all)
    const wKYPatched = content.includes(wKYReplacement) && content.includes(wKYThinkingReplacement);
    const wKYNeedsPatching = content.includes(wKYSearchPattern) || content.includes(wKYThinkingSearchPattern);

    // Check for new custom peach patched version (this script's target with theme colors)
    if (content.includes(cg8CustomReplacement)) {
      if (wKYPatched && redactPatched) {
        return { status: 'patched', canPatch: false, variant: 'custom-peach-v3' };
      } else if (wKYNeedsPatching || redactNeedsPatching) {
        const missing = [];
        if (wKYNeedsPatching) missing.push('wKY gate');
        if (redactNeedsPatching) missing.push('redact-thinking header');
        return { status: 'patched-other', canPatch: true, variant: 'custom-peach-incomplete', note: `Has cg8 patch but missing: ${missing.join(', ')}` };
      }
    ...
    if (content.includes(cg8OldCustomReplacement) && content.includes('\ud83c\udf51 Thinking Process')) {
    ...
    if (content.includes(cg8StandardReplacement)) {
      return { status: 'patched-other', canPatch: true, variant: 'standard', note: 'Has standard patch, can upgrade to custom' };
    }

    // Check for any other patch variant (has the if(!1) pattern in cg8 but different styling)
    if (content.includes('function cg8(q)') && content.match(/function cg8\(q\)[^}]*if\(!1\)return null/)) {
      if (wKYNeedsPatching) {
        return { status: 'patched-other', canPatch: true, variant: 'partial-no-wKY', note: 'cg8 patched but wKY gate not patched (thinking hidden by default)' };
      }
      return { status: 'patched', canPatch: false, variant: 'custom-other' };
    }

    // Check for unpatched original
    if (content.includes(cg8SearchPattern)) {
      return { status: 'unpatched', canPatch: true };
    }

    // Check if it's a different version (has cg8 but different pattern)
    if (content.includes('function cg8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Different version or structure' };
    }

    // Check for v2.1.109 version (oF8 function)
    if (content.includes('function oF8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.109 detected - use patch-thinking-v2.1.109-custom-peach.js' };
    }

    // Check for v2.1.107 version (qU8 function)
    if (content.includes('function qU8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.107 detected - use patch-thinking-v2.1.107-custom-peach.js' };
    }

    // Check for v2.1.104 version (Ng8 function)
    if (content.includes('function Ng8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.104 detected - use patch-thinking-v2.1.104-custom-peach.js' };
    }

    // Check for v2.1.90 version (AI8 function)
    if (content.includes('function AI8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.90 detected - use patch-thinking-v2.1.90-custom-peach.js' };
    }

    // Check for v2.1.89 version (Wx8 function)
    if (content.includes('function Wx8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.89 detected - use patch-thinking-v2.1.89-custom-peach.js' };
    }

    // Check for v2.1.85 version (Xb8 function)
    if (content.includes('function Xb8(q)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.85 detected - use patch-thinking-v2.1.85-custom-peach.js' };
    }

    // Check for v2.1.81 version (rE8 function)
    if (content.includes('function rE8(A)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.81 detected - use patch-thinking-v2.1.81-custom-peach.js' };
    }

    // Check for v2.1.76 version (_N1 function)
    if (content.includes('function _N1(A)')) {
      return { status: 'unknown', canPatch: false, reason: 'Version v2.1.76 detected - use patch-thinking-v2.1.76-custom-peach.js' };
    }
    ...
    return { status: 'unknown', canPatch: false, reason: 'cg8 function not found (wrong version?)' };
  } catch (e) {
    return { status: 'error', canPatch: false, reason: e.message };
  }
}

// Old cg8 custom replacement (with hex colors - for upgrading)
const cg8OldCustomReplacementFull = 'function cg8(q){let K=s(17),{param:_,addMargin:z,isTranscriptMode:Y,verbose:A,hideInTranscript:O}=q,{thinking:w}=_,$=z===void 0?!1:z,j=O===void 0?!1:O;if(!w)return null;if(!1)return null;if(!1){let W=$?1:0,D;if(K[8]===Symbol.for("react.memo_cache_sentinel"))D=R96.default.createElement(T,{dimColor:!0,italic:!0},"\u2234 Thinking"," ",R96.default.createElement(U2,null)),K[8]=D;else D=K[8];let Z;if(K[9]!==W)Z=R96.default.createElement(u,{marginTop:W},D),K[9]=W,K[10]=Z;else Z=K[10];return Z}let J=$?1:0,X;if(K[11]===Symbol.for("react.memo_cache_sentinel"))X=R96.default.createElement(T,{color:"#FFA500",bold:!0},"\ud83c\udf51 Thinking Process"),K[11]=X;else X=K[11];let M;if(K[12]!==w)M=R96.default.createElement(u,{paddingLeft:1,marginTop:1},R96.default.createElement(xw,null,w)),K[12]=w,K[13]=M;else M=K[13];let P;if(K[14]!==J||K[15]!==M)P=R96.default.createElement(u,{flexDirection:"column",borderStyle:"single",borderColor:"#FFA500",paddingX:1,marginTop:J,width:"100%"},X,M),K[14]=J,K[15]=M,K[16]=P;else P=K[16];return P}';
...
function applyPatch(installation) {
  ...
  // Next, always check and apply wKY patches (the outer gate)
  if (content.includes(wKYSearchPattern)) {
    content = content.replace(wKYSearchPattern, wKYReplacement);
    wKYPatchApplied = true;
    console.log('   \u2705 wKY redacted_thinking gate patched: if(!M&&!O) -> if(!1)');
  }
  if (content.includes(wKYThinkingSearchPattern)) {
    content = content.replace(wKYThinkingSearchPattern, wKYThinkingReplacement);
    wKYPatchApplied = true;
    console.log('   \u2705 wKY thinking gate patched: if(!M&&!O) -> if(!1)');
  }

  // Check if cg8 is already fully patched with custom peach style
  if (content.includes(cg8CustomReplacement)) {
    if (wKYPatchApplied || modified) {
      fs.writeFileSync(installation.path, content, 'utf8');
      console.log('   \u2705 Gate/redact patches applied (cg8 was already patched)');
      return true;
    }
  ...
  if (content.includes(cg8OldCustomReplacementFull)) {
    content = content.replace(cg8OldCustomReplacementFull, cg8CustomReplacement);
    modified = true;
    console.log('   \u2705 cg8 upgraded from hex colors to theme colors!');
  }
  // Can patch from standard version too
  else if (content.includes(cg8StandardReplacement)) {
    content = content.replace(cg8StandardReplacement, cg8CustomReplacement);
    modified = true;
    console.log('   \u2705 cg8 upgraded from standard to custom peach style!');
  }
  // Patch fresh from original
  else if (content.includes(cg8SearchPattern)) {
    content = content.replace(cg8SearchPattern, cg8CustomReplacement);
    modified = true;
    console.log('   \u2705 cg8 patch applied!');
  ...
  if (modified || wKYPatchApplied) {
    fs.writeFileSync(installation.path, content, 'utf8');
    if (!modified && wKYPatchApplied) {
      console.log('   \u2705 wKY gate patches applied successfully!');
    }
    return true;
  } else {
...
async function main() {
  console.log('Claude Code Thinking Custom Peach Style Patcher v2.1.112');
  console.log('========================================================');
  ...
  if (installations.length === 0) {
    ...
    console.error('Please make sure Claude Code v2.1.112 is installed via npm.');
